...
src = cv2.imread('ch09//conjuring.jpg', cv2.IMREAD_GRAYSCALE)
src = cv2.imread('ch09//cruella.jpg', cv2.IMREAD_GRAYSCALE)
src = cv2.imread('ch09//quiet-place.jpg', cv2.IMREAD_GRAYSCALE)
...
cap2 = cv2.VideoCapture('ch09//conjuring.mp4')
cap2 = cv2.VideoCapture('ch09//cruella.mp4')
cap2 = cv2.VideoCapture('ch09//quiet-place.mp4')
